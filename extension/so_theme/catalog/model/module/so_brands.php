...
class SoBrands extends \Opencart\System\Engine\Model {
	
	public function getManufacturers($data = array()) {
		if ($data) {
            $filters = explode(',', $data['filter_manufacturer_id']);
			...
			$sql .= " AND m.manufacturer_id IN (" . $data['filter_manufacturer_id'] . ")";
