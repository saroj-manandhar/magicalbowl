...
class SoExtraSlider extends \Opencart\System\Engine\Model {
	...
	public function getImageExtra_slider($product_id) {
	...
	public function getProducts_extra_slider($data = array()) {
