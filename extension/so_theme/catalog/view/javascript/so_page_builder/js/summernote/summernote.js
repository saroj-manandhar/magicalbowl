...
!(function (t, e) {
  ...
  return (function (t) {
      ...
      3: function (t, e, n) {
          ...
          function rt(t, e) {
              var n, o;
              if (W(t.node)) return { node: (n = t.node.nextSibling), offset: (o = 0) };
              if (U(t.node) === t.offset) {
                  if (S(t.node)) return null;
                  var i = at(t.node);
                      ...
                      (n = [
                          {
                              ...
                              value: function () {
                                  ...
                                  var e = yt({ node: this.sc, offset: this.so });
                                  return e.setEndPoint("EndToEnd", yt({ node: this.ec, offset: this.eo })), e;
                              },
                          },
                          {
                              key: "getPoints",
                                  ...
                                  switch (c.action) {
                                      ...
                                      case At.resultAction.SumSpanCount:
                                          if ("top" === e && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= o[0].rowIndex) {
                                              var d = i()("<div></div>")
                                                  .append(i()("<td" + u + ">" + pt.blank + "</td>").removeAttr("rowspan"))
                                                  .html();
                                              a.append(d);
                                              break;
                                          }
                                  ...
                                  if (a[s]) {
                                      ...
                                      switch (a[s].action) {
                                          ...
                                          case At.resultAction.SubtractSpanCount:
                                              u &&
                                                  (d > 2
                                                      ? (d--, l.setAttribute("rowSpan", d), c.rowIndex !== r && l.cellIndex === o && (l.innerHTML = ""))
          ...
          var Ht = (function () {
              function t(e) {
                  ...
                  for (
                      var o = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor"], r = 0, a = o.length;
                      r < a;
                      r++
                  )
                      (this[o[r]] = (function (t) {
                  ...
                  (n = [
                      ...
                      },
                      {
                          ...
                          value: function () {
                              ...
                              if (
                                  (this.$codable.val(pt.html(this.$editable, this.options.prettifyHtml)),
                              ...
                              this.context.memo("button.justifyLeft", g.invoke(r, "render")),
                                  ...
                                  this.context.memo("button.table", function () {
                                      return t.ui
                                          .buttonGroup(
                                              [
                                                  t.button({ className: "dropdown-toggle", contents: t.ui.dropdownButtonContents(t.ui.icon(t.options.icons.table), t.options), tooltip: t.lang.table.table, data: { toggle: "dropdown" } }),
                                                  t.ui.dropdown({
                      ...
                      },
                      {
                          ...
                          value: function () {
                              ...
                              !this.isFollowing && a > l && a < c - n
                                  ? ((this.isFollowing = !0), this.$editable.css({ marginTop: this.$toolbar.outerHeight() }), this.$toolbar.css({ position: "fixed", top: r, width: e, zIndex: 1e3 }))
                      ...
                      },
                      {
                          ...
                          value: function (t) {
                              ...
                              if (n && 11 === n[1].length) {
                                  ...
                                  e = i()("<iframe>")
                                      .attr("frameborder", 0)
                                      .attr("src", "//www.youtube.com/embed/" + m + (v > 0 ? "?start=" + v : ""))
                                      .attr("width", "640")
                                      .attr("height", "360");
                                  ...
                                  e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                                      .attr("frameborder", 0)
                                  ...
                                  e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                                      ...
                                      .attr("height", "310")
                                      .attr("width", "500")
                                      .attr("src", "https://v.qq.com/txp/iframe/player.html?vid=" + w + "&amp;auto=0");
                              } else if (d || h || f) e = i()("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");
                              else {
                                  if (!p || !p[0].length) return !1;
                                  e = i()("<iframe>")
                                      .attr("frameborder", 0)
                                      .attr("src", "https://www.facebook.com/plugins/video.php?href=" + encodeURIComponent(p[0]) + "&show_text=0&width=560")
                                      .attr("width", "560")
                                      .attr("height", "301")
                                      .attr("scrolling", "no")
                                      .attr("allowtransparency", "true");
      ...
      52: function (t, e, n) {
                  ...
                  e.fade && t.addClass("fade"),
                      ...
                      t.html(
                          [
                              ...
                              e.title ? '<div class="modal-header"><button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button><h4 class="modal-title">' + e.title + "</h4></div>" : "",
          ...
          n(3), n(4);
          i.a.summernote = i.a.extend(i.a.summernote, { ui_template: x, interface: "bs3" });
      },
  });
});
