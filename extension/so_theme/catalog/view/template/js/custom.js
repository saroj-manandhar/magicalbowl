...
jQuery(document).ready(function($) {
    ...
    /* Smooth vertical megamenu hover buffer */
    var verticalMenuTimer;
    $(document).on('mouseenter', '.container-megamenu.vertical', function() {
        clearTimeout(verticalMenuTimer);
        $(this).addClass('is-hovered');
        $(this).find('.vertical-wrapper').stop(true, true).fadeIn(150);
    });

    $(document).on('mouseleave', '.container-megamenu.vertical', function() {
        var $menu = $(this);
        verticalMenuTimer = setTimeout(function() {
            $menu.removeClass('is-hovered');
            $menu.find('.vertical-wrapper').stop(true, true).fadeOut(150);
        }, 350);
    });
