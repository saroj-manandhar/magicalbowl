...
class QuickviewHeader extends \Opencart\System\Engine\Controller {
	public function index() {
		...
		$this->load->language('common/header','',$this->config->get('config_language_catalog'));
		...
		return $this->load->view('extension/so_theme/soconfig/quickview_header', $data);
	}
}
