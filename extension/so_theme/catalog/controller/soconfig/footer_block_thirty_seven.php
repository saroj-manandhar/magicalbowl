...
class FooterBlockThirtySeven extends \Opencart\System\Engine\Controller {
	public function index() {
		...
		$modules 	= $this->model_design_layout->getModules($layout_id, 'footer_block37');
		...
		return $this->load->view('extension/so_theme/position/content_block', $data);
	}
}
