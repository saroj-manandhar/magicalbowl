...
define('CACHE_LITE_ERROR_RETURN_MEGAMENU', 1);
define('CACHE_LITE_ERROR_DIE_MEGAMENU', 8);
...
class Cache_Lite
{
    ...
    */
    var $_pearErrorMode = CACHE_LITE_ERROR_RETURN_MEGAMENU;
    ...
    */
    ...
    /**
     * API break for error handling in CACHE_LITE_ERROR_RETURN_MEGAMENU mode
     * 
     * In CACHE_LITE_ERROR_RETURN_MEGAMENU mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in CACHE_LITE_ERROR_RETURN_MEGAMENU mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', CACHE_LITE_ERROR_DIE_MEGAMENU);
    }
