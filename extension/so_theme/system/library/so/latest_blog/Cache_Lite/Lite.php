...
*/
define('CACHE_LITE_ERROR_RETURN_SOLATESTBLOG', 1);
define('CACHE_LITE_ERROR_DIE_SOLATESTBLOG', 8);
...
class Cache_Lite
{
    ...
    */
    var $_pearErrorMode = CACHE_LITE_ERROR_RETURN_SOLATESTBLOG;
    ...
    */
    ...
    /**
     * API break for error handling in CACHE_LITE_ERROR_RETURN_SOLATESTBLOG mode
     * 
     * In CACHE_LITE_ERROR_RETURN_SOLATESTBLOG mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in CACHE_LITE_ERROR_RETURN_SOLATESTBLOG mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', CACHE_LITE_ERROR_DIE_SOLATESTBLOG);
    }
