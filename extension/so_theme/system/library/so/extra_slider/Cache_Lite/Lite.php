...
*/
define('CACHE_LITE_ERROR_RETURN_EXTRASLIDER', 1);
define('CACHE_LITE_ERROR_DIE_EXTRASLIDER', 8);
...
class Cache_Lite
{
    ...
    */
    var $_pearErrorMode = CACHE_LITE_ERROR_RETURN_EXTRASLIDER;
    ...
    */
    ...
    /**
     * API break for error handling in CACHE_LITE_ERROR_RETURN_EXTRASLIDER mode
     * 
     * In CACHE_LITE_ERROR_RETURN_EXTRASLIDER mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in CACHE_LITE_ERROR_RETURN_EXTRASLIDER mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', CACHE_LITE_ERROR_DIE_EXTRASLIDER);
    }
