...
define('CACHE_LITE_ERROR_RETURN_LISTINGTABS', 1);
define('CACHE_LITE_ERROR_DIE_LISTINGTABS', 8);
...
class Cache_Lite
{
    ...
    */
    var $_pearErrorMode = CACHE_LITE_ERROR_RETURN_LISTINGTABS;
    ...
    */
    ...
    /**
     * API break for error handling in CACHE_LITE_ERROR_RETURN_LISTINGTABS mode
     * 
     * In CACHE_LITE_ERROR_RETURN_LISTINGTABS mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in CACHE_LITE_ERROR_RETURN_LISTINGTABS mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', CACHE_LITE_ERROR_DIE_LISTINGTABS);
    }
    ...
    */
    function _setFileName($id, $group)
    {
        ...
        if ($this->_fileNameProtection) {
            $suffix = 'cache_'.md5($group).'_'.md5($id->scalar);
        } else {
            $suffix = 'cache_'.$group.'_'.$id->scalar;
        }		
