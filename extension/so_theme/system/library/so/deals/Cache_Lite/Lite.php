...
*/
define('CACHE_LITE_ERROR_RETURN_SODEALS', 1);
define('CACHE_LITE_ERROR_DIE_SODEALS', 8);
...
class Cache_Lite
{
    ...
    */
    var $_pearErrorMode = CACHE_LITE_ERROR_RETURN_SODEALS;
    ...
    */
    ...
    /**
     * API break for error handling in CACHE_LITE_ERROR_RETURN_SODEALS mode
     * 
     * In CACHE_LITE_ERROR_RETURN_SODEALS mode, error handling was not good because
     * for example save() method always returned a boolean (a PEAR_Error object
     * would be better in CACHE_LITE_ERROR_RETURN_SODEALS mode). To correct this without
    ...
    */
    function setToDebug()
    {
        $this->setOption('pearErrorMode', CACHE_LITE_ERROR_DIE_SODEALS);
    }
