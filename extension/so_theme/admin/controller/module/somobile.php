...
require_once (DIR_EXTENSION.'so_theme/admin/view/template/soconfig/class/so_fieldMobile.php');
require_once (DIR_EXTENSION.'so_theme/admin/view/template/soconfig/class/soconfig.php');

class SoMobile extends \Opencart\System\Engine\Controller {
    ...
    public function index() {
		/*===== Load language ========== */
		$this->load->language('extension/so_theme/module/somobile','',isset($this->request->cookie['language'])?$this->request->cookie['language']:$this->config->get('config_language'));
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_extension_so_theme_module_soconfig_setting->editMobile( $this->request->post,$store_id);	
			...
			if($this->request->post['buttonForm'] == 'color' ){
				...
				if(!$data['scsscompile']){
					...
					$this->response->redirect($this->url->link('extension/so_theme/module/somobile', 'user_token=' . $this->session->data['user_token'], 'SSL'));
				}else{
				...
				$this->response->redirect($this->url->link('extension/so_theme/module/somobile', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store_id, true));
			} else {
		...
		if (($this->request->server['REQUEST_METHOD'] != 'POST') || $this->request->server['REQUEST_METHOD'] == 'POST' && $this->validate() ) {
			$module_info = $this->model_extension_so_theme_module_soconfig_setting->getMobile($store_id);
		...
		// ---------------------------Load module --------------------------------------------
		/*$data['clear_cache_href'] = $this->url->link('extension/so_theme/module/soconfig/clearcache', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['clear_css_href'] = $this->url->link('extension/so_theme/module/soconfig/clearcss', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['compiled_css'] = $this->url->link('extension/so_theme/module/soconfig/compiled_css', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		*/
		...
		$data['base_href'] = $this->url->link('extension/so_theme/module/somobile', 'user_token=' . $this->session->data['user_token'].'&store_id='.$store_id, 'SSL');
		$data['action'] = $this->url->link('extension/so_theme/module/somobile', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store_id, true);
		...
		$data['fields'] = $fields;
		$this->response->setOutput($this->load->view('extension/so_theme/soconfig/somobile', $data));
	}
	...
	public function uninstall() {
		...
		$this->model_setting_event->deleteEventByCode('so_somobile');				
    }
    ...
    public function install(){
		...
		//$main_sql = DIR_EXTENSION.'so_theme/admin/view/template/soconfig/demo/mobile/install.php';
	...
	private function setupEvent() {
		...
		$this->removeEvent();
		$this->load->model('extension/so_theme/module/soconfig/setting');
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/home/before", "extension/so_theme/event/so_somobile.so_theme_home_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/header/before", "extension/so_theme/event/so_somobile.so_theme_header_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/search/before", "extension/so_theme/event/so_somobile.so_theme_search_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/language/before", "extension/so_theme/event/so_somobile.so_theme_language_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/currency/before", "extension/so_theme/event/so_somobile.so_theme_currency_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/common/footer/before", "extension/so_theme/event/so_somobile.so_theme_footer_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/product/product/before", "extension/so_theme/event/so_somobile.so_theme_product_before" , 1 , 1);
		
		$this->model_extension_so_theme_module_soconfig_setting->addEvent('so_somobile','', "catalog/view/product/category/before", "extension/so_theme/event/so_somobile.so_theme_category_before" , 1 , 1);		
    ...
    protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/so_theme/module/somobile')) {
