...
$_['heading_title_so']    	= 'So Filter Shop By <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 3.0.0</b>';
...
$_['condition_search_option']    		= 'Condition Search';
$_['condition_search_option_desc'] 		= 'Condition Search for Product Options';
