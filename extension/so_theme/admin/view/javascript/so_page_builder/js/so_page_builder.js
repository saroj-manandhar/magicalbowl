(function($) {
	...
	function editWidget(mod){
		...
		$(".so-page-wedit",mod).bind( 'click', function(){
			...
			if(type=="module"){
				...
				$("#ifmEditModule").on('load', function(){
	...
	function func_creatColumn(row){
		...
		var sort = $('<div class="so-page-sortable-col so-page-icon" data-iconTitle="'+textCol["sortCol"]+'"><i class="fas fa-arrows-alt"></i></div>');
		var del = $('<div class="so-page-delete so-page-icon" data-iconTitle="'+textCol["deleteCol"]+'"><i class="fas fa-trash-alt"></i></div></div>');
		...
		var add_shortcode = $('<div class="so-page-addShortcode so-page-icon" data-iconTitle="'+textCol["addShortcode"]+'"><i class="far fa-plus-square"></i></div>');
	...
	function func_creatRow( srow, sub ){
		...
		var sort 	= $('<div class="so-page-sortable so-page-icon" data-iconTitle="'+textRow["sortRow"]+'"><i class="fas fa-arrows-alt"></i></div>');
		var del 	= $('<div class="so-page-delete so-page-icon" data-iconTitle="'+textRow["deleteRow"]+'"><i class="fas fa-trash-alt"></i></div>');
		
		
		var copy 	= $('<div class="so-page-copy so-page-icon" data-iconTitle="'+textRow["duplicateRow"]+'"><i class="fa fa-copy"></i></div>');
		var addcol 	= $('<div class="so-page-add-col so-page-icon" data-iconTitle="'+textRow["addCol"]+'" data-bs-toggle="modal" data-bs-target="#config_column" data-backdrop="static" data-keyboard="false"><i class="fa fa-plus"></i></div>' );
