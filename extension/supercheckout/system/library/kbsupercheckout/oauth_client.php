...
class oauth_client_class
{
     ...
     */
    var $oauth_password = '';
    var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.112 $)';
                        ...
                        '{STATE}', UrlEncode($state), str_replace(
                                '{CLIENT_ID}', UrlEncode($this->client_id), str_replace(
                                        '{API_KEY}', UrlEncode($this->api_key), str_replace(
                                                '{SCOPE}', UrlEncode($this->scope), $url)))));
        return true;
    }
    ...
    function ProcessToken2($code, $refresh)
    {
        ...
        if ($this->server == 'Yahoo') {
            $access_token = array(
                'value' => ($this->access_token = $response['id_token']),
                'authorized' => true,
            );
        } else {
            $access_token = array(
    ...
    function RetrieveToken(&$valid)
    {
        ...
        if (isset($access_token['value'])) {
            ...
            if (isset($access_token['type'])) {
                ...
                if (strlen($this->access_token_type) && !$expired && $this->debug)
            ...
            if (isset($access_token['secret'])) {
                ...
                if ($this->debug && !$expired && strlen($this->access_token_secret))
    ...
    function Initialize()
    {
        ...
        switch ($this->server) {
            ...
            case 'LinkedIn':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
                $this->access_token_url = 'https://www.linkedin.com/oauth/v2/accessToken';
                $this->access_token_parameter = 'oauth2_access_token';
                break;
            ...
            case 'Yahoo':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://api.login.yahoo.com/oauth2/request_auth?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&response_type=code&state={STATE}';
                $this->access_token_url = 'https://api.login.yahoo.com/oauth2/get_token';
                break;

            case 'Amazon':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://www.amazon.com/ap/oa?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&response_type=code&state={STATE}';
                $this->access_token_url = 'https://api.amazon.com/auth/o2/token';
                break;
            ...
            case 'Paypal':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://www.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize?client_id={CLIENT_ID}&response_type=code&scope={SCOPE}&redirect_uri={REDIRECT_URI}';
                $this->access_token_url = 'https://www.paypal.com/webapps/auth/protocol/openidconnect/v1/tokenservice';
                break;
            ...
            case 'Wordpress':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://public-api.wordpress.com/oauth2/authorize?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&response_type=code&state={STATE}&scope={SCOPE}';
                $this->access_token_url = 'https://public-api.wordpress.com/oauth2/token';
                break;

            case 'VK':
                $this->oauth_version = '2.0';
                //$this->dialog_url = 'https://oauth.vk.com/authorize?&client_id={CLIENT_ID}&scope={SCOPE}&redirect_uri={REDIRECT_URI}&response_type=token&state={STATE}';
                $this->dialog_url = 'https://oauth.vk.com/authorize?client_id={CLIENT_ID}&scope={SCOPE}&redirect_uri={REDIRECT_URI}&response_type=code&state={STATE}';
                //$this->access_token_url = 'https://oauth.vk.com/access_token?client_id={CLIENT_ID}&client_secret=XCd67Kihn2sJlUkpcZ7l&code={$_GET["code"]}&redirect_uri={REDIRECT_URI}';
                //$resp = Tools::file_get_contents($client->access_token_url);
                //print_r($resp);
                break;

            case 'Dropbox2':
                $this->oauth_version = '2.0';
                $this->dialog_url = 'https://www.dropbox.com/1/oauth2/authorize?response_type=code&client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
                $this->access_token_url = 'https://www.dropbox.com/1/oauth2/token';
                break;
