...
require_once dirname(dirname(__FILE__))."/".'service/apiModel.php';
require_once dirname(dirname(__FILE__))."/".'service/apiService.php';
require_once dirname(dirname(__FILE__))."/".'service/apiServiceRequest.php';
...
class apiOauth2Service extends apiService {
  /**
   * Variables decalred since in php version 8, variable needs to be declared first in the clss before accessing them
