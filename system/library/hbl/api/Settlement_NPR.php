 ...
 * Class Settlement
 *
 * Handles Settlement API requests (Normal + JOSE encrypted)
 */
class Settlement extends ActionRequest_NPR
{
    /**
     * Execute normal JSON Settlement request
     *
    ...
    /**
     * Execute JOSE (JWS + JWE) encrypted Settlement request
     *
     * @param string $officeId
     * @param string $orderNo
     * @param string $productDescription
