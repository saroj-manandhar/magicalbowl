...
class Checkout extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$supercheckout_settings = $this->model_setting_setting->getSetting('supercheckout', $this->config->get('config_store_id'));
		if (!empty($supercheckout_settings['supercheckout']['general']['enable'])) {
			$this->response->redirect($this->url->link('extension/supercheckout/supercheckout/supercheckout', 'language=' . $this->config->get('config_language')));
			return;
		}
