...
class Product extends \Opencart\System\Engine\Controller {
	...
	public function form(): void {
		...
		// Recomended
		if ($product_id) {
			$product_recomendeds = $this->model_catalog_product->getRecomended($product_id);
		} else {
			$product_recomendeds = [];
		}

		$data['product_recomendeds'] = [];

		foreach ($product_recomendeds as $recomended_id) {
			$recomended_info = $this->model_catalog_product->getProduct($recomended_id);

			if ($recomended_info) {
				$data['product_recomendeds'][] = $recomended_info;
			}
		}
